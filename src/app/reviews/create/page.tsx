...
import { CreateReviewRequest, AIModel } from '@/types';
...
export default function CreateReviewPage() {
    ...
    const { loading, createReview } = useReviewsStore();
    const [models, setModels] = useState<AIModel[]>([]);
    const [selectedModel, setSelectedModel] =
        useState<AIModel | null>(null);
    const [formData, setFormData] =
        useState<CreateReviewRequest>({
            modelId: 0,
            title: '',
            content: '',
            rating: 5,
    ...
    const handleInputChange = (
        field: keyof CreateReviewRequest,
        value: any
    ) => {
        setFormData((prev) => ({
            ...prev,
    ...
    const handleModelSelect = (modelId: string) => {
        ...
        handleInputChange('modelId', parseInt(modelId));
    };
